...
""" Se le asigna la variable al ping de la ESP 32"""
...
while True:
    ...
    if datosentrada == 0:
        ledentrada.value(1)
        # ESP32 Presentacion en la Pantalla Oled
...
# Pago
        ...
        if Cobro <= 0:
            ...
            if pago == 50 or pago == 100 or pago == 200 or pago == 500 or pago == 1000 or pago == 2000 or pago == 5000 or pago == 10000 or pago == 20000 or pago == 50000 or pago == 100000:
                print("exito")
                Cobro = Cobro - pago
